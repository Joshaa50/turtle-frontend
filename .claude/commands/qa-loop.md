...
Orchestrate the QA loop for Turtle Guard. You are the orchestrator: you do NOT test and you do
...
3. If it reports `status: fail` → use the **fixer** subagent to address the failures in
   qa-report.json. Do not fix anything yourself, and do not relay your own opinion about the
